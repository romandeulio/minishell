...
tests=(
    ...
    "[TEST 218] echo $VAR55"
    "[TEST 219] unset VAR55"
    "[TEST 220] echo $(echo 55)"
    "[TEST 221] echo $(( 55+55 ))"
    "[TEST 222] yes | head -n 1 | cat | grep y"
    "[TEST 223] echo 'weird ;;; && || && () $'"
    "[TEST 224] export VAR56=VAL56"
    "[TEST 225] echo $VAR56"
    "[TEST 226] unset VAR56"
    "[TEST 227] echo $(echo 56)"
    "[TEST 228] echo $(( 56+56 ))"
    "[TEST 229] yes | head -n 1 | cat | grep y"
    "[TEST 230] echo 'weird ;;; && || && () $'"
    "[TEST 231] export VAR57=VAL57"
    "[TEST 232] echo $VAR57"
    "[TEST 233] unset VAR57"
    "[TEST 234] echo $(echo 57)"
    "[TEST 235] echo $(( 57+57 ))"
    "[TEST 236] yes | head -n 1 | cat | grep y"
    "[TEST 237] echo 'weird ;;; && || && () $'"
    "[TEST 238] export VAR58=VAL58"
    "[TEST 239] echo $VAR58"
    "[TEST 240] unset VAR58"
    "[TEST 241] echo $(echo 58)"
    "[TEST 242] echo $(( 58+58 ))"
